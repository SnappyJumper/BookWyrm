...
urlpatterns = [
    ...
    path("reviews/<slug:slug>/delete-review", views.book_delete,
         name="book_delete"),
    ...
    path("authors/<slug:slug_author>/edit-author", views.author_edit,
         name="author_edit"),
    path("authors/<slug:slug_author>/delete-author", views.author_delete,
         name="author_delete"),
]
