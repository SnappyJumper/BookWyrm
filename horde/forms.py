...
class BookReviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            # Changes the book_published input to a Date Input and
            # applies the form-control class to it
            "book_published": forms.DateInput(attrs={"type": "date",
                                                     "class": "form-control"}),
            "review": SummernoteWidget(),  # Allows the user to create rich
            # text content for the review field
        }
...
class AuthorForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            # Applies additional properties to each field when displayed
            # Changes the date_of_birth input to a Date Input and applies
            # the form-control class to it
            "date_of_birth": forms.DateInput(attrs={"type": "date",
                                                    "class": "form-control"}),
            "bio": SummernoteWidget(),  # Allows the user to create rich
            # text content for the bio field
        }
